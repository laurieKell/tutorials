...
ggplot(transform(ldply(FLQuants(
...
eql=FLBRPs(mlply(expand.grid(m  =1:2,
    ...
    fn=function(v,msy){
          ...
          params(res)[c("a","b")]=ab(FLPar("s"=par["s"],
                                           "v"=v),"bevholt",spr0(res))[c("a","b")]
          (computeRefpts(res)["msy","yield"]-msy)^2}
    
     params(res)[c("a","b")]=ab(FLPar("s"=par["s"],
                                      "v"=optimise(fn,c(0,5000),200)$minimum),
...
save(eql,file="/home/laurie/Desktop/flr/tutorials/advice_framework/data/eql.RData")
```
