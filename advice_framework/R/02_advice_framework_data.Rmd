...
![](../tex/cohort.png)
**Figure `r iFig=iFig+1; iFig`.** Cohort tracking through catch-at-age.
...
In the first case, growth cannot be determined exactly, but is derived from the combined growth of all fish from year *italics y* to year *italics y+1*.
