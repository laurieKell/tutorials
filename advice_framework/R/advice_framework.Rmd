...
Then we can
    ...
    i) compare the assessment models
    ii) run some simulations using a shiny app where we vary options, i.e. M, steepness, ...
    iii) run simulations with HCR options
    iiii) convert Catch-at-size to Catch-at-age and run a VPA
